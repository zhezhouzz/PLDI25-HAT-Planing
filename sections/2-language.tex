...
{\footnotesize
  \begin{alignat*}{2}
    ...
    % ~|~ \eff{obs}
    \\[-0.2em]\text{\textbf{Events}} & \quad & m ::= \quad & \langle\eff{op}{\; \overline{v}}\rangle
...
additional ghost events ($F$).  The typing rule for function (\textsc{TFun}) is standard, and the type
