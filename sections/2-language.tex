...
\begin{example}[Operator Application Typing]\label{ex:operator-application-typing}
  ...
  \vspace{-.4cm} \par\nobreak {\small %
    ...
    \end{align*}}%
  \noindent
  As before, we can instantiate the ghost variable $n$ as $1$ and $m$ as $0$ via rule \textsc{SubG}, align the return type via rule \textsc{SubHF} and refine the history regex via the rule \textsc{TOpHis} as shown below:
  \vspace{-.4cm} \par\nobreak {\footnotesize %
    \begin{flalign*}
