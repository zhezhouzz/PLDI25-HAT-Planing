...
\begin{example}[Read Atomicity]\label{ex:read-atomicity}
  ...
  \begin{align*}
    &\text{\textcolor{gray}{Client 1:}}  & \zevent{writeReq}{\tau_1,4};\zevent{writeRsp}{\tau_1,4};&
    \\& \text{\textcolor{gray}{Client 2:}} \quad \zevent{readReq}{\tau_2,3};\zevent{readRsp}{\tau_2,3};\zevent{readReq}{\tau_2};& &\zevent{readRsp}{\tau_2,4}
  \end{align*}}
  ...
  $\eff{readReq}$ events admits executions that satisfy read atomicity:
   \begin{align*}
    \eff{readReq} :~ \rg{\Code{LAST}(\msgA{readRsp}{\tau\;x})}{\msgA{readReq}{\tau\;x}}{\Code{FIRST}(\msgA{readRsp}{\tau\;x})}
  \end{align*}
