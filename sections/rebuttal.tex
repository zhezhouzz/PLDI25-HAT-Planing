...
is precisely why P's existing model checker opts to tradeoff
...
As the reviewers note, these controllers are incomplete: and are only
guaranteed to generate some (l823), but not all (l921), feasible
executions consistent with provided specifications. Our experimental
...
information enables us to be significantly more directed in our search
for a violating execution than would otherwise be possible--- history
