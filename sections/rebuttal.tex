...
\end{align*}}\noindent
The predicate \(\I{next}(n_1, n_2)\) indicates that node \(n_2\) is the next node of \(n_1\) in the ring. The two intersected \PAT{}s of \(\eff{nominate}\) describe two situations when a node receives a nomination message:  
\begin{enumerate}  
...
{\small\begin{align*}
  ...
  \\&\quad \effLR{\finalA \msg{eInitAccount}{}}\effLR{\lastA\msg{eReadQuery}{\I{rId} = \Code{id}\land\I{accountId} = \Code{ac} \land \I{amount} = \Code{am}}}
  \\&\quad \effLR{\finalA\msg{eReadQuery}{\I{rId} = \Code{id}\land\I{accountId} = \Code{ac} \land \I{amount} = \Code{am}}}
\end{align*}}\noindent