...
paper.  In our setting, we show how interpreting type specifications
from the lens of underapproximation can guide a synthesis procedure to
construct bespoke test generators tailored to the property of
interest, and cognizant of the behavior of the operators provided by
the SUT.  As a mechanism to characterize underapproximate behavior,
types identify \emph{sufficient} constraints that any test input
