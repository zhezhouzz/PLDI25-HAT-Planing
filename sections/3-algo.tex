...
The second phase of our synthesis algorithm constructs a generator
program from a set of abstract traces using \derive{}. This algorithm
relies on a subroutine, \deriveTrace{}, that generates straightline
