...
The trace update erase ghost variables:
\begin{align*}
  (m{:}\urt{\Int}{\vnu = 0}, n{:}\urt{\Int}{\vnu = m{+}1}, y{:}\urt{\Int}{\top}, x{:}\urt{\Int}{\vnu > y}, \msgA{push}{x};\msgA{pop}{x})
\end{align*}

\begin{minted}[fontsize = \footnotesize, escapeinside=??, xleftmargin=10pt, linenos]{ocaml}
  let (x: int) = int_gen () in assume (?$\exists m\;n\;y. m = 0 \land n = m{+}1 \land x > y$?) in push x; (* equal to assume true *)
