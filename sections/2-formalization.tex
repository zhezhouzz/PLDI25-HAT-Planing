...
\begin{theorem}[Fundamental Theorem]\label{theorem:fundamental} Given
  ...
  $\Gamma; \Delta; \Theta \vdash e : \tau \implies \forall \sigma, \sigma \in
    ...
    \denotation{\sigma(\tau)}$.\footnote{The proofs of all theorems in this paper are provided in the \techreport{}.}
\end{theorem}
