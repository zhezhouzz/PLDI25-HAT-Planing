...
\begin{definition}[Well-formed handler context]
  ...
  The handler specification $\Delta$ and capablity context $\Sigma$ is well-formed iff for all operator $\eff{op}$ and its \PAT $\overline{y{:}b} \garr \overline{x{:}t} \sarr \rg{H}{\lastA\msgB{op}{\overline{y}}{\phi}}{F}$ and capability $\Theta$ in $\Delta$ satisfying
{\small\begin{align*}
