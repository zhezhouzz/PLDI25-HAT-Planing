...
applied to concrete values $(\zevent{op}{\overline{v}})$. Evaluating a
  ...
  {\footnotesize
    \begin{align*}
      ...
      & \Gamma \vdash \Code{x}\hasnty{int}
        ...
        \tag{\textsc{TSub}}} \\
      &\Gamma;\Delta; \emptyset \vdash P_{C} \text{ (lines $3$ - $7$)}: \rg{\epsTL}{A_1\seqA A_2\seqA A_3\seqA A_4}{\epsTL}
        \tag{\textsc{TGen}}
    \end{align*}
  }\noindent %
...
{\small\begin{align*}
    &\forall \overline{y{:}b}.\forall \alpha_h \in \denot{H}. \forall \overline{c \in \denotation{t}}. \forall \overline{c_{ij}}.\forall \overline{\alpha_i}. \alpha_1 \listconcat [\zevent{op_1}{\overline{c_{1j}}}] \listconcat ... [\zevent{op_n}{\overline{c_{nj}}}] \listconcat \alpha_{n+1} \in \denot{F} \impl \alpha_h \vDash \zevent{op}{\overline{c}} \Downarrow \{m_i\} \land \phi\msubst{x}{c}
\end{align*}} 
\end{definition}
