...
{\footnotesize\begin{align*}
  \denot{\rg{H}{A}{F}} \doteq & \{e ~|~ \emptyset \basicvdash e : \Code{unit} \land \forall \alpha_h \;\alpha\;\alpha_f\;\beta_1\;\beta_2. \underbrace{\exists e_h. \msteptr{[]}{(\emptyset, e_h)}{\alpha_h}{(\beta_1, ())}}_\texttt{realizable histroy trace} \land  \alpha_h \in\denot{H} \impl 
  \\[-0.4em] & \quad \underbrace{\msteptr{\alpha_h}{(\beta_1, e)}{\alpha}{(\beta_2, ())}}_\texttt{trace produced by $e$} \impl \alpha \in\denot{A} \land (\alpha_f \in\denot{F} \impl \underbrace{\exists e_f.\msteptr{\alpha_h \listconcat \alpha }{(\beta_2, e_f)}{\alpha_f}{(\emptyset, ())}}_\texttt{realizable future trace}) \} \\
  \denot{\rg{H}{A}{F}} \doteq & \{e ~|~ \emptyset \basicvdash e : \Code{unit} \land \forall \alpha_h \;\alpha\;\alpha_f\;\beta_1\;\beta_2. \underbrace{\exists e_h. \msteptr{[]}{(\emptyset, e_h)}{\alpha_h}{(\beta_1, ())}}_\texttt{realizable histroy trace} \land  \alpha_h \in\denot{H} \impl 
  \\[-0.4em] & \quad \underbrace{\msteptr{\alpha_h}{(\beta_1, e)}{\alpha}{(\beta_2, ())}}_\texttt{trace produced by $e$} \impl \alpha \in\denot{A} \land (\alpha_f \in\denot{F} \impl \underbrace{\exists e_f.\msteptr{\alpha_h \listconcat \alpha }{(\beta_2, e_f)}{\alpha_f}{(\emptyset, ())}}_\texttt{realizable future trace}) \}
\end{align*}}\noindent
