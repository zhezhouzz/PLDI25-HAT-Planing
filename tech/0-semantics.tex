...
\begin{figure}[t!]
    ...
    \\[0.4em]
    \mprooftr{90mm}{}{StWhile1}{
    $\steptr{\alpha}{(\buf, \zwhile{e_1}{e_2})}{[]}{(\buf, e_2)}$
    }
    \\[0.4em]
    \mprooftr{100mm}{}{StWhile2}{
    $\steptr{\alpha}{(\buf, \zwhile{e_1}{e_2})}{[]}{(\buf, e_1;\zwhile{e_1}{e_2})}$
    }
}
...
\quad
\begin{prooftree}
\hypo{\Gamma \basicvdash e_1 : \Unit
\quad \Gamma \basicvdash e_2 : \Unit}
\infer1[\textsc{BtChoice}]{
\Gamma \basicvdash \zwhile{e_1}{e_2} : \Unit
}
\end{prooftree}
\\ \ \\ \ \\
\begin{prooftree}
