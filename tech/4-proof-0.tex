...
In the \autoref{sec:language}, we defined the well-formedness of effectful operator typing context, we also define the well-formedness of pure operator typing context.
