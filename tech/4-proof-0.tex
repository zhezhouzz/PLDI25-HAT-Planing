...
{\footnotesize\begin{alignat}{2}
  ...
  &\sigma(\lambda \overline{x}.\eff{op}\;\overline{x}) \in \denot{\sigma(\overline{x{:}t_x}\sarr\uhat{H'}{t}{F})} \ptag{by \ref{found:6-2} and \ref{found:6-4} and definition~\ref{lemma:built-in-typing} } \label{found:6-5}
  \end{alignat}}\noindent
Then, the conclusion is consistent with the denotation definition, thus the case is proved.
\item:
{\footnotesize
...
\begin{corollary}[Type Soundness] A generator \(e\) that satisfies
