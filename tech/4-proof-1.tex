...
In this paper, we omit the proof of basic typing \(\basicvdash e : s\), assuming that all terms and qualifiers in our typing rules and theorems are type-safe. 

\subsection{Lemmas}

Before presenting the proof of the fundamental theorem and type soundness, we introduce several useful lemmas.
...
The fundamental theorem for controller program contains two parts, 1) the history, current, and future trace of a well-typed term $e$ is consistent with the corresponding \PAT; 2) the realizability guarantee provided by capability. We first prove the first part, as the following.
