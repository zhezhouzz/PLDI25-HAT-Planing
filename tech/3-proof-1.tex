...
In this paper, we omit the proof of basic typing \(\basicvdash e : s\), assuming that all terms and qualifiers in our typing rules and theorems are type-safe. Before presenting the proof of the fundamental theorem and type soundness, we introduce several useful lemmas.

\subsection{Lemmas}

\paragraph{Lemmas for s-LTL$_f$} 
...
\paragraph{Lemma for denotations}
...
\paragraph{Lemma for handler context}
