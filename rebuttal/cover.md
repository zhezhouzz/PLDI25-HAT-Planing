...
The major changes are as follows (all line numbers mentioned below refer to `clouseau-diff.pdf`):

- We clarify how Clouseau handles faulty executions due to non-determinism (lines 815-820).

- We have expanded the explanations of the motivating examples in Section 2 (lines 213-216, 297-303, and 329-331).
