...
{\small
  \begin{alignat*}{2}
    ...
    \\ \text{\textbf{Expressions}}& \quad & e ::=\quad & v ~|~ \zlet{x}{\primop\ \overline{v}}{e} ~|~ \zgen{op}{\overline{v}}{e} ~|~ \zobs{\overline{x}}{op}{e} 
    \\ & & \quad & ~|~ \zassert{v}{e} ~|~ e \oplus e
...
\\ \text{\textbf{Qualifiers}}& \quad & \phi ::= \quad & v ~|~ \bot ~|~ \top  ~|~ \neg \phi ~|~ \phi \land \phi ~|~ \phi \lor \phi ~|~ \phi \impl \phi ~|~ \forall x{:}b.\, \phi
    ...
    \rg{H}{A}{F} ~|~ x{:}t\sarr \tau ~|~ \tau \interty \tau
...
\begin{align*}
  ...
  \\&&& \qquad\qquad (\alpha_H \in\denot{H} \impl \alpha \in\denot{A} \land \alpha_F\in\denot{F}) \land (\alpha_F \in\denot{F} \impl \alpha \in\denot{A} \land \alpha_H\in\denot{H}) \}
