...
{\small
  \begin{alignat*}{2}
    \\ \text{\textbf{Symbolic Plan }}& \quad  & \Pi ::= \quad & \epsilon ~|~ \msgB{op}{\overline{x}}{\phi} ~|~ \acSe{op}{\overline{v}} ~|~ A^\acStar ~|~ \Pi \seqA \Pi
...
\begin{enumerate}
    ...
    \item Backward Synthesis $\Gamma \vdash \planTri{\Pi_1}{\acSe{op}{\overline{v}}}{\Pi_2} \inferBW \Pi'$, needs to guarantee that all $\acSe{op}{\overline{v}}$ in $\Pi'$ are consistent with $\Delta$.
\end{enumerate}
